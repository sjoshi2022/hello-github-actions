...
/**
    * My ETA Passed Input Intent controller
    * @param {object} df webhook fulfillment object
    * @param {object} params Global Parameters
    */
const etaPassed = async (df, params) => {
    try {
        ...
        if ((calculatedETA == null) || (calculatedETA == "") || (calculatedETA <= 0)) {
            ...
            if ((updateddETA == null) || (updateddETA == "") || (updateddETA <= 0)) {
                message = params.chatConfigApi.ETAPassed;
                chips = [CHIPS.yes, CHIPS.noThanks];
            ...
            df.setOutputContext(CONTEXTS.ChatETAPassedFollowup, 1);
            df.setSuggestions({
                "title": message,
                "suggestions": chips
            });
