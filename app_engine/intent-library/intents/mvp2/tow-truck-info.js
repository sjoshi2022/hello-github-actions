...
"use strict";
const { CONTEXTS, OPLIFESPAN, CHIPS, EVENTS } = require("../../../helper/constants");
...
/**
   * Tow Truck Information Input Intent controller
   * @param {object} df webhook fulfillment object
   * @param {object} params Global Parameters
   */
const towTruckInfo = async (df, params) => {
    try {
        ...
        if ((calculatedETA == null) || (calculatedETA == "") || (calculatedETA <= 0)) {
            ...
            if ((updateddETA == null) || (updateddETA == "") || (updateddETA <= 0)) {
                ...
                message = params.chatConfigApi.towTruckInfo.replace("$time", updateddETA);
        ...
        logger.log("error", `Webhook call failed: ${err.message}`, "intent-library/intents/tow-truck-info", { "message": err, session: params.dfSessionID });
        throw err;
    }
};

module.exports = towTruckInfo;
